<x-layout.auth>
    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
        <div
            ...
            <div class="relative">
                <img :src="$store.app.theme === 'dark' || $store.app.isDarkMode ? '/assets/images/error/503-dark.svg' :
                    '/assets/images/error/503-light.svg'"
                    alt="503" class="mx-auto w-full max-w-xs object-cover md:max-w-xl" />
