<x-layout.auth>
    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
        <div
            ...
            <div class="relative">
                <img :src="$store.app.theme === 'dark' || $store.app.isDarkMode ? '/assets/images/error/404-dark.svg' :
                    '/assets/images/error/404-light.svg'"
                    alt="404" class="mx-auto -mt-10 w-full max-w-xs object-cover md:-mt-14 md:max-w-xl" />
                <p class="mt-5 text-base dark:text-white">The page you requested was not found!</p>
                <a href="{{ route('dashboard') }}"
                    class="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">Home</a>
            </div>
        </div>
    </div>
