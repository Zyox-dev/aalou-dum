        ...
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-10 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo_2.png" alt="image" />
                </a>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                src={{ 'https://robohash.org/' . auth()->user()->email }} alt="image" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                            ...
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="rounded-md w-10 h-10 object-cover"
                                        src={{ 'https://robohash.org/' . auth()->user()->email }} alt="image" />
                                </div>
                        ...
                        <li>
                            <a href={{ route('company-data.edit') }} class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="12" cy="6" r="4" stroke="currentColor"
                                        stroke-width="1.5" />
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            ...
                            <a href="#" class="text-danger !py-3"
                                @click.prevent="document.getElementById('logout-form').submit(); toggle();">
